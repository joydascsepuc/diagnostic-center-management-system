<div class="col-md-10">
  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col">
        <p class="text-danger font-weight-bold">Delivery Pending Reports</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col table table-responsive text-center pl-0 pr-0 table-striped">
          <table class="table" id="datatable">
            ...
            <tbody>
              <?php foreach ($pendingReports as $pReport): ?>
                <tr>
                  ...
                  <td>
                    <a class="text-secondary font-weight-bold" href="<?php echo base_url();?>tests/loadGivePendingReport/<?=$pReport['id'];?>"><i class="fas fa-paste">&nbsp;Deliver Report</i></a>
                    </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
