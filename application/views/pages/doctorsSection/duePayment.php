					...
					<table class="table" id="datatable">
					  <thead>
					    <tr>
					      ...
					      <th scope="col">Last Pay Amount</th>         
					      <th>Pay:</th>
					    </tr>
					  </thead>
					  <tbody>
					  	<?php foreach ($doctors as $doctor): ?>
						    <tr>
						      ...
						      <td>
						      	<a class="text-secondary font-weight-bold" href="<?php echo base_url(); ?>doctorsection/loadPayDoctor/<?php echo $doctor['id']; ?>"><i class="fas fa-donate"></i></a>
					      	  </td>
						    </tr>
					    <?php endforeach; ?>
					  </tbody>
