            ...
            <div id="profile" class="ml-2 mt-3">
                <div>
                    <div class="p-1">
                        ...
                        <p class="text-success font-weight-bold"><?php echo $this->session->userdata('name');?><br>Position: <?php echo $this->session->userdata('admintype');?></p>
                    </div>
                </div>
            </div>

            <nav class="navbar mt-5 mr-0">
              <!-- Links -->
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url(); ?>employees/load_add_employee">Add New</a>                                   
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>doctorsection/load_add_doctor">Add New</a>
                    ...
                    <a class="dropdown-item" href="<?php echo base_url(); ?>doctorsection/paymentHistory">Payment History</a>
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>tests/LoadAddUnit">Add Unit</a>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>tests/LoadAllUnit">View All Units</a>
                  </div>
                </li>

                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                    <i class="fas fa-sticky-note"></i> Test Reports &nbsp; &nbsp; <i class="fas fa-plus float-right"></i>
                  </a>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url() ?>testReports/loadAddRecord">Add Record</a>
                    <a class="dropdown-item" href="<?php echo base_url() ?>testReports/loadPrintPendings">Print Pendings</a>
                    <a class="dropdown-item" href="#">Print Previous</a>
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>departments/load_add_department">Add new</a>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url();?>appointments/LoadAddNew">Add new</a>
                    <a class="dropdown-item" href="<?php echo base_url();?>appointments/allAppoints">All Appointments</a>
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url();?>salary/loadentrysalary">Salary Entry</a>
                    <a class="dropdown-item" href="<?php echo base_url();?>salary/loadchecksalary">Check Salary</a>                    
                  </div>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>supers/setting">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                   <i class="fas fa-user"></i> Users Control &nbsp; &nbsp; <i class="fas fa-plus float-right"></i>
                  </a>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>users/load_addnewuser">Add new</a>
