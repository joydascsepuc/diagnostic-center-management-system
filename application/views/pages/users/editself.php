...
<div class="col-md-10">
	...
	<div class="row mb-3">
	 ...
	 <?php echo form_open('users/updateself'); ?>
    <div id="box">
	    <?php foreach($users as $user):?>
	    	<div class="row">
	    		<div class="col">
				    ...
				    <input type="text" class="form-control" id="name" placeholder="Give name" name="name" value="<?=$user['name'];?>"  autofocus>
				  </div>
	    		</div>
	    		...
	    		<div class="col">
				    ...
				    <input type="mobile" class="form-control" id="mobile" placeholder="Give number" name="mobile" value="<?php echo $user['mobile']; ?>">
				  </div>
	    		</div>
	    	</div>
	    	...
	    	<div class="row">
	    		...
	    		<div class="col">
				    ...
				    <input type="password" class="form-control" id="password" placeholder="Give Password" name="password" value="<?php echo $user['password']; ?>">
				  </div>
	    		</div>
	    	</div>
