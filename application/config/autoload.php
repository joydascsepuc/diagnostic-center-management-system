...
*/
$autoload['model'] = array('LoginModel','Patients_Model','Users_Model','Departments_Model','Employee_Model','Doctor_Section_Model','Tests_Model','Salary_Model','Appoints_Model','TestReports_Model');
